...
hospital_df = pd.read_excel("Project_Hospital_Recommendation\Hospitals_list.xlsx")  # or .csv if you're using csv

app = Flask(__name__)

# Load the trained model and encoders
model = joblib.load('Project_Hospital_Recommendation\Model_Training\Hospital_prediction_model.pkl')
...
def predict():
    ...
    Hospital_type_list = ["Multi-speciality", "ENT", "Eye","General","Gynecology", "Cardiology",
